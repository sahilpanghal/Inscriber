...
def Result():
    ...
    if (i==1):
        ...
        messagebox.showinfo('Inscriber', 'Please Choose one of Encryption or Decrption. Try again.')
...
headingLabel = Label(headingFrame1, text=" Welcome to Inscriber", fg='grey19', font=('Courier',13,'bold'))
...
label3 = Label(wn, text='Choose one of encrypt or decrypt', font=('Courier',10))
